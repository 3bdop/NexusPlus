...
const BaseCanvas = ({ children = undefined, fov = 50, position = new three.Vector3(0, 0, 5), style, dpr = [BASE_DPR * 0.5, 2], className }) => (React__default["default"].createElement(fiber.Canvas, { key: fov, className: `${styles$1['base-canvas']} ${className !== null && className !== void 0 ? className : ''}`, shadows: "soft", gl: { preserveDrawingBuffer: true, alpha: true, toneMappingExposure: 1.6, toneMapping: three.ACESFilmicToneMapping }, dpr: dpr, camera: { fov, position }, resize: { scroll: true, debounce: { scroll: 50, resize: 0 } }, style: Object.assign(Object.assign({}, style), { background: 'transparent' }) }, children));
...
const AnimationModel = ({ modelSrc, animationSrc, rotation = 20 * (Math.PI / 180), scale = 1, idleRotation = false, setModelFallback, onLoaded, headMovement = false, emotion, bloom }) => {
    ...
    useFallback(nodes, setModelFallback);
    return (React__default["default"].createElement(Model, { modelRef: ref, scene: scene, scale: scale, onLoaded: onLoaded, onSpawnAnimationFinish: onSpawnAnimationFinish, bloom: bloom }));
};
...
const Lights = (lightingProps) => {
    ...
    return (React__default["default"].createElement("group", null,
        ...
        React__default["default"].createElement("spotLight", { position: LIGHT_CONFIG.keyLightPosition, target: targets.head, angle: LIGHT_CONFIG.keyLightAngle, color: keyLightColor, intensity: keyLightIntensity, castShadow: true }),
        React__default["default"].createElement("spotLight", { position: LIGHT_CONFIG.liftLightPosition, target: targets.shoe, angle: LIGHT_CONFIG.keyLightAngle, color: keyLightColor, intensity: keyLightIntensity * 0.25, castShadow: true }),
        React__default["default"].createElement("spotLight", { position: LIGHT_CONFIG.silhouetteLightPosition, target: targets.head, angle: LIGHT_CONFIG.silhouetteLightAngle, color: keyLightColor, intensity: keyLightIntensity * 0.25, castShadow: true })));
};
...
const Avatar = ({ modelSrc, animationSrc = undefined, poseSrc = undefined, environment = 'soft', halfBody = false, shadows = false, scale = 1, cameraTarget = CAMERA.TARGET.FULL_BODY.MALE, cameraInitialDistance = CAMERA.INITIAL_DISTANCE.FULL_BODY, style, emotion, idleRotation = false, capture, background, onLoaded, onLoading, dpr, className, headMovement = false, cameraZoomTarget = CAMERA.CONTROLS.FULL_BODY.ZOOM_TARGET, onLoadedEffect, onLoadedAnimation, children, effects, keyLightIntensity, keyLightColor, fillLightIntensity, fillLightColor, fillLightPosition, backLightIntensity, backLightColor, backLightPosition, lightTarget, fov = 50 }) => {
    ...
    const AvatarModel = React.useMemo(() => {
        ...
        if (!!animationSrc && !halfBody && isValidFormat(animationSrc)) {
            return (React__default["default"].createElement(AnimationModelContainer, { emotion: emotion, modelSrc: modelSrc, animationSrc: animationSrc, scale: scale, idleRotation: idleRotation, onLoaded: onLoaded, headMovement: headMovement, bloom: effects === null || effects === void 0 ? void 0 : effects.bloom }));
        }
        if (halfBody) {
            return (React__default["default"].createElement(HalfBodyModelContainer, { emotion: emotion, modelSrc: modelSrc, scale: scale, idleRotation: idleRotation, onLoaded: onLoaded, headMovement: headMovement, bloom: effects === null || effects === void 0 ? void 0 : effects.bloom }));
        }
        if (isValidFormat(poseSrc)) {
            return (React__default["default"].createElement(PoseModelContainer, { emotion: emotion, modelSrc: modelSrc, scale: scale, poseSrc: poseSrc, onLoaded: onLoaded, bloom: effects === null || effects === void 0 ? void 0 : effects.bloom }));
        }
        return (React__default["default"].createElement(StaticModelContainer, { modelSrc: modelSrc, scale: scale, onLoaded: onLoaded, emotion: emotion, bloom: effects === null || effects === void 0 ? void 0 : effects.bloom }));
    ...
    return (React__default["default"].createElement(BaseCanvas, { position: new three.Vector3(0, 0, 3), fov: fov, style: style, dpr: dpr, className: className },
        ...
        ((effects === null || effects === void 0 ? void 0 : effects.ambientOcclusion) || (effects === null || effects === void 0 ? void 0 : effects.bloom) || (effects === null || effects === void 0 ? void 0 : effects.vignette)) && (React__default["default"].createElement(postprocessing.EffectComposer, { autoClear: true, multisampling: 4 },
            React__default["default"].createElement(React__default["default"].Fragment, null,
                (effects === null || effects === void 0 ? void 0 : effects.ambientOcclusion) && (React__default["default"].createElement(postprocessing.SSAO, { blendFunction: postprocessing$1.BlendFunction.MULTIPLY, distanceScaling: false, radius: 0.08, bias: 0.01, intensity: 3, samples: 31, worldDistanceThreshold: 24, worldDistanceFalloff: 0, worldProximityThreshold: 0, worldProximityFalloff: 6, fade: 0.02, rings: 8 })),
